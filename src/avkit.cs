...
#region AVPlayerViewControllerSubtitleOptions
	...
	[Category]
	[BaseType (typeof(AVPlayerView))]
	interface AVPlayerView_AVPlayerViewCustomization
	{
		...
		[NullAllowed, Export ("actionPopUpButtonMenu", ArgumentSemantic.Assign)]
	...
	[Category]
	[BaseType (typeof(AVPlayerView))]
	interface AVPlayerView_AVPlayerViewPictureInPictureSupport
	{
		[Mac (10, 15)]
		[Export ("allowsPictureInPicturePlayback")]
		bool AllowsPictureInPicturePlayback { get; set; }
		...
		[NullAllowed]
		AVPlayerViewPictureInPictureDelegate PictureInPictureDelegate { get; set; }
	...
	[NoWatch, Mac (10,15), iOS (9,0), TV (13,0)]
	[Protocol, Model]
	[BaseType (typeof(NSObject))]
	...
	[iOS (9,0), Mac (10,15), TV (13,0), NoWatch]
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
#if XAMCORE_4_0
